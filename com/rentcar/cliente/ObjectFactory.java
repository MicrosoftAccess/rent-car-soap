 ...
 * generated in the com.rentcar.cliente package. 
...
public class ObjectFactory {
    ...
    private final static QName _Saludar_QNAME = new QName("http://soap.rentcar.com/", "saludar");
    private final static QName _SaludarResponse_QNAME = new QName("http://soap.rentcar.com/", "saludarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rentcar.cliente
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.rentcar.com/", name = "saludar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.rentcar.com/", name = "saludarResponse")
